...
export const DEFAULT_CONFIG: ServerConfig = {
  ...
  version: getEnv('MINECRAFT_VERSION', '1.20.1'),
  neoforgeVersion: getEnv('NEOFORGE_VERSION', '47.1.106'),
  javaVersion: getEnv('JAVA_VERSION', '17.0.9+9'),
  baseUrl: getEnv('SERVER_BASE_URL', 'https://localhost/modpack'),
  modsListUrl: getEnv('SERVER_MODS_LIST_URL', 'https://localhost/modpack/mods.json'),
